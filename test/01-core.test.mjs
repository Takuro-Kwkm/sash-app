...
test('03 canonical v0.7 base source lineage is retained while formal CUSTOM v1.0 and STANDARD v1.1 regeneration bind separately',()=>{const product=c.products.find(x=>x.id===p),s=product.source;assert.equal(s.id,'1zHi-XsMqJp0MKH-sDoTcnTqkLMGcuRdo');assert.equal(s.version,'v0.7');assert.equal(s.folder,'01_正本');assert.equal(product.standardRuntimeRegeneration.version,'v1.1');assert.equal(product.standardRuntimeRegeneration.formalMaster.sha256,'9d4a0812cadc6d804a8e8db77ad0e4b042d674e62b9ef9edfcd2afcab9c9e5a6');});
