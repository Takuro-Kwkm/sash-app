...
test('historical v1.8 size delta remains bound to its exact post-production formal Master revision and SHA',()=>{
...
test('v1.8 size regeneration inventory remains exactly formal 1644 / selectable 1495 with 85 approved additions',()=>{
...
test('v1.8 manual standard official source and current Runtime remain exact 97-set equality',()=>{
...
test('v1.8 manual standard construction split remains 51 在来・204 plus 46 在来',()=>{
...
test('generic Runtime resolver still exposes all 97 formal manual-standard candidates without cross-product generation',()=>{
  let total=0;
