...
try {
  ...
  assert.deepEqual(ready,new Set(['SER-LIX-EW','SER-LIXIL-TW','SER-YKKAP-UCHIRIMO']));
  assert.deepEqual(blocked,new Set(['SER-LIX-SAMOS2H','SER-LIX-SAMOSL','SER-YKK-APW430','SER-YKK-APW431']));
