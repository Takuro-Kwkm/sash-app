...
export function transitionPending(issue,nextStatus,{evidenceIds=[],ruleIds=[],resolutionNote=null,at=new Date().toISOString(),by='CHATGPT'}={}){
  ...
  if(nextStatus==='RESOLVED'&&evidenceIds.length===0)throw new Error('RESOLVED PENDING requires resolution Evidence');
  ...
  return{
    ...
    ...(nextStatus==='RESOLVED'?{resolutionEvidenceIds:[...evidenceIds],resolutionRuleIds:[...ruleIds],resolutionNote,resolvedAt:at,resolvedBy:by}:{})
  };
}
