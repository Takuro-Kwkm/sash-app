...
export const runtimeMasterInventory = Object.freeze([
  Object.freeze({
    ...
    packageType: 'FORMAL_PRODUCT_RUNTIME', adapterType: 'PRODUCT_MODULE_RUNTIME_V1', productModuleRole: 'RUNTIME_JSON_PACKAGE',
    packageRoot: SAMOS2H_ROOT,
    runtimeManifestPath: join(SAMOS2H_ROOT, 'runtime_manifest.json'),
    runtimeManifestDriveFileId: '1TkMSmr5dC8TDO6tmAL1gs0bHZrgvHuug',
    runtimeManifestSha256: '4e912379d05395d2f96403040c2eaa1b68c4124f4af2116a5b2fae53c004efd9',
  ...
  Object.freeze({
    manufacturer: 'LIXIL', series: 'サーモスL', productId: 'SER-LIX-SAMOSL', masterVersion: 'v0.7-R1', schemaVersion: '2.0',
    packageType: 'FORMAL_PRODUCT_RUNTIME', adapterType: 'PRODUCT_MODULE_RUNTIME_V1', productModuleRole: 'runtime_master',
    packageRoot: THERMOSL_ROOT,
    runtimeManifestPath: join(THERMOSL_ROOT, 'runtime_manifest.json'),
    runtimeManifestDriveFileId: '1UKh-RS97d6l1xELaxoy-X-0HJgPXuSL2',
    runtimeManifestSha256: '29d1ef4725d7b277b468034cba07bfaba1202d8bf62e5180d4e38ec2fd4a64cd',
    materializedFiles: Object.freeze({
  ...
  Object.freeze({
    ...
    materializedFiles: Object.freeze({
      '1soPPTqP9LNKWFS1wxWhN8Lux6p9ZdyYf': Object.freeze({ codec: 'brotli', paths: Object.freeze(EW_RUNTIME_SEGMENTS.map((name) => join(EW_ROOT, `LIXIL_EW_runtime_v1.1.json.br.b64.segments/${name}`))) }),
    }),
  }),
  Object.freeze({
    manufacturer: 'YKK AP', series: 'APW430', productId: 'SER-YKK-APW430', masterVersion: '20260830-R1', schemaVersion: 'product-master-runtime-manifest/1.0',
    packageType: 'FORMAL_PRODUCT_RUNTIME', adapterType: 'APW430_FORMAL_SPLIT_V1',
    packageRoot: APW430_ROOT,
    runtimeManifestPath: join(APW430_ROOT, 'runtime_manifest.json'),
    runtimeManifestDriveFileId: '1kzVrhxbArbmUu9MgLThODKTEuCdxyqfK',
    runtimeManifestSha256: '08f3ad4bef73e32b00e9a69af7e0278539bc8899d64713c8f903924cd43de78b',
    materializedFiles: Object.freeze({
  ...
  Object.freeze({
    ...
    materializedFiles: Object.freeze({
      '1yt4ADBqoK4-5Xqt6bJ593Q4thi81IRzI': Object.freeze({ codec: 'brotli', paths: Object.freeze([join(TW_ROOT, 'LIXIL_TW_runtime_integrated-v0.2.json.br.b64.parts/part-00')]) }),
    }),
  }),
]);
...
export async function loadRegisteredRuntime(manufacturer, series) {
  ...
  if (!runtimePromises.has(key)) {
    runtimePromises.set(key, loadRuntime(entry).catch((error) => { runtimePromises.delete(key); throw error; }));
  }
