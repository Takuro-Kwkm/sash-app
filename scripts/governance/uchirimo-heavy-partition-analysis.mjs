...
if(depth1Proof.exact_head!==DH||depth1Proof.parent_partition_count!==514||depth1Proof.split_parent_count!==514||depth1Proof.child_partition_count!==2106||depth1Proof.coverage_preservation_status!=='PASS'||depth1Proof.PARTITION_OVERLAP_COUNT!==0||depth1Proof.PARTITION_GAP_COUNT!==0)throw new Error('DEPTH1_COVERAGE_PROOF_INVALID');
...
if(depth5Binding.exact_head!==DH||depth5Binding.source_evidence_role!=='DIAGNOSTIC_TARGET_IDENTITY_ONLY'||depth5Binding.current_runtime_manifest_sha256!==runtimeHash)throw new Error('DEPTH5_SOURCE_BINDING_INVALID');
...
const blockers=[
  ...
  {code:'DEPTH5_AND_DEEPER_REPRESENTATIVE_DIAGNOSTIC_ONLY',detail:'Depth-5 and downstream recovery evidence is explicitly representative-only and does not prove all branches descending from the 514 original parents.'},
  {code:'NO_COMPLETE_514_PARENT_TO_CLOSED_TERMINAL_MAPPING',detail:'The 21/21 frame-installation closure covers the seven-lane diagnostic model, not a mechanically complete 514-parent closure map.'}
];
...
const binding={source_exact_head:SH,source_run_id:Number(SR),source_artifact_identity:SA,source_artifact_sha256:SD,current_exact_head:head,changed_paths:changed,dependency_fingerprint:dependencyFingerprint,impact_decision:'CLOSURE_GAP_ANALYSIS_ONLY_SOURCE_MEASUREMENTS_BOUND_AND_REVALIDATED',measurement_reexecuted:false};
...
writeJson(`${OUT}/explicit-constraint-frame-installation-mode21-to-original514-closure-proof.json`,{schema_version:'1.0.0',artifact_type:'UCHIRIMO_FRAME_INSTALLATION_MODE21_TO_ORIGINAL514_CLOSURE_PROOF',exact_head:head,current_runtime_manifest_sha256:runtimeHash,current_head_evidence_binding:binding,original_heavy_parent_count:514,initial_partition_child_count:2106,initial_partition_coverage_preservation_status:'PASS',frame_installation_mode_closed_child_count:21,frame_installation_mode_closure_status:'PASS',frame_model_lane_count:7,depth1_representative_calibrated_child_count:11,depth1_representative_pass_count:1,depth1_full_child_execution_authorized:false,bath_original_heavy_parent_count:38,bath_depth1_child_count:76,bath_representative_pass_child_count:1,bath_excluded_from_depth2:true,depth2_parent_count:2030,depth2_child_count:7364,depth2_full_execution_authorized:false,depth5_representative_parent_count:10,depth5_representative_child_count:33,depth5_diagnostic_scope:depth5Plan.diagnostic_scope,minimum_unresolved_original_parent_count:38,complete_514_parent_to_terminal_closure_mapping_present:false,all_514_original_heavy_partitions_covered:false,blockers,execution_performed:false,status:'BLOCKED'});
writeJson(`${OUT}/explicit-constraint-original514-closure-decision.json`,{schema_version:'1.0.0',artifact_type:'UCHIRIMO_ORIGINAL514_CLOSURE_DECISION',exact_head:head,frame_installation_mode_21_closed:true,original_heavy_parent_count:514,all_514_original_heavy_partitions_covered:false,minimum_unresolved_original_parent_count:38,closure_gap_count:blockers.length,next_recovery_action:'BUILD_ORIGINAL_514_PARENT_TO_TERMINAL_CLOSURE_MAP_AND_IDENTIFY_UNVERIFIED_BRANCHES',frame_reexecution_authorized:false,new_partition_authorized:false,full_constraint_execution_authorized:false,full_coverage_authorized:false,REQUESTED_CHANGE_SCOPE:'UCHIRIMO_HEAVY_RECOVERY_FRAME_INSTALLATION_MODE_21_TO_ORIGINAL_514_CLOSURE_PROOF',REQUESTED_DIFF_COVERAGE:'PASS',UNREQUESTED_DIFF_COUNT:0,UCHIRIMO_FULL_COVERAGE_QA_GATE:'BLOCKED',UCHIRIMO_QA_STATUS:'UNVERIFIED',APP_INTEGRATION_READY:false,RELEASE_INPUT_GATE:'BLOCKED',status:'BLOCKED'});
...
console.log('MINIMUM_UNRESOLVED_ORIGINAL_PARENT_COUNT=38');
console.log('BLOCKER=BATH_38_PARENTS_EXCLUDED_FROM_DEPTH2_BY_SINGLE_REPRESENTATIVE_PASS');
console.log('BLOCKER=DEPTH5_AND_DEEPER_REPRESENTATIVE_DIAGNOSTIC_ONLY');
console.log('NEXT_RECOVERY_ACTION=BUILD_ORIGINAL_514_PARENT_TO_TERMINAL_CLOSURE_MAP_AND_IDENTIFY_UNVERIFIED_BRANCHES');
