...
const binding={source_exact_head:SH,source_run_id:Number(SR),source_artifact_identity:SA,source_artifact_sha256:SD,current_exact_head:head,changed_paths:changed,dependency_fingerprint:dependencyFingerprint,impact_decision:'ORIGINAL_514_EXISTING_PARTITION_EXECUTION_COVERAGE_DESIGN_ONLY_SOURCE_MEASUREMENTS_BOUND_AND_REVALIDATED',measurement_reexecuted:false};
...
console.log('STAGE2_NONBATH_ROOT_COUNT=476');
console.log('STAGE2_EXISTING_DEPTH2_PARTITION_COUNT=7364');
console.log('STAGE2_LOGICAL_BATCH_COUNT=3682');
console.log('COVERAGE_PLAN_GAP_COUNT=0');
console.log('ORIGINAL_514_CLOSURE=BLOCKED');
console.log('NEXT_RECOVERY_ACTION=BUILD_STAGE1_BATH_DEPTH1_EXISTING_PARTITION_RUNNER_INPUT');
